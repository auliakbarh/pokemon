export const FETCH_LIST_POKEMON = 'fetching list of pokemons';
export const FETCH_LIST_POKEMON_SUCCESS = 'fetching list of pokemons success';
export const FETCH_LIST_POKEMON_FAILED = 'fetching list of pokemons failed';
